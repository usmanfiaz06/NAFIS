...
async function main() {
  console.log("Seeding NAFIS database...");
  ...
  for (const o of orders) {
    ...
    // Create shipment if vessel data exists
    if (o.ship && o.mmsi) {
  ...
  console.log(`Created ${orders.length} import orders`);
    ...
    data: [
      {
        ...
        message:
          "Wheat import pipeline is 35% below the 90-day rolling average. Only 130,000 MT in pipeline vs 200,000 MT average. Consider expediting pending approvals or sourcing additional suppliers.",
      ...
      },
      {
        ...
        message:
          "78% of rice imports in the current pipeline originate from India. Recommended maximum concentration is 60% per origin. Diversification needed — consider Thailand, Vietnam, or Pakistan sources.",
      ...
      },
      {
        ...
        message:
          "MV Black Sea Trader carrying 55,000 MT of Russian wheat arriving at Jeddah Islamic Port within 7 days. Ensure port clearance capacity and storage availability.",
        relatedCommodity: "Wheat",
      },
      {
        type: "CONCENTRATION_RISK",
        ...
        message:
          "100% of poultry meat imports sourced from Brazil. Supply chain disruption risk is elevated. Recommend qualifying alternative suppliers from Turkey or Thailand.",
      ...
      },
      {
        ...
        message:
          "Palm oil and sunflower oil pipeline covers only 45 days of national consumption. Minimum recommended buffer is 60 days. Two pending orders await approval.",
      ...
      },
      {
        ...
        message:
          "MV Gujarat Star has arrived at King Abdulaziz Port with 25,000 MT of sugar from India. Clearance process should be initiated.",
        relatedCommodity: "Sugar (Cane/Beet)",
      },
    ],
  });

  console.log("Created 6 alerts");
